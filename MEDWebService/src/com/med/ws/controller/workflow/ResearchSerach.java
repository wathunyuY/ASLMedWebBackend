...
@Service
@Transactional
public class ResearchSerach extends AbstractWorkflowController {
	...
	public ResponseBody processTask(ProcessBean processBean) throws Exception {
		...
		rs.setResearchRsTypes(service.findResearch(processBean.getRequest().getResearchSearchRqType()));
		return rs;
	}
