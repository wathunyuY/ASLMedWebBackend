...
public class SearchStdntBean {
	...
	protected String acadPlanDescr;
	protected String acadProg;
	protected String acadCampus;
	...
	public String getAcadCampus() {
		return acadCampus;
	}
	public void setAcadCampus(String acadCampus) {
