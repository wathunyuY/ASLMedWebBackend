...
public class EvaDTO {
	...
	ArrayList<EvaSections> evaluationSections;
	...
	public static class EvaSections {
		@JsonProperty("_id")
		Integer evaluationSectionId;
		@JsonProperty("descr")
		...
		ArrayList<EvaQuestion> evaluationQuestions;

		public static class EvaQuestion {
			@JsonProperty("_id")
			...
			ArrayList<EvaAnswer> evaluationAnswers;
			@JsonProperty("answer")
			String selectedAnswer;
			@JsonProperty("answerDetail")
			EvaAnswer answerDetail;
			@JsonProperty("answerTypeId")
			private Integer answerTypeId;
			@JsonProperty("maxScore")
			private Double maxScore;

			public static class EvaAnswer {
				@JsonProperty("_id")
				Integer evaluationAnswerId;
				@JsonProperty("descr")
				...
				public Integer getEvaluationAnswerId() {
					return evaluationAnswerId;
				}

				public void setEvaluationAnswerId(Integer evaluationAnswerId) {
			...
			public ArrayList<EvaAnswer> getEvaluationAnswers() {
				return evaluationAnswers;
			}

			public void setEvaluationAnswers(ArrayList<EvaAnswer> evaluationAnswers) {
			...
			public Integer getEvaluationQuestionId() {
				return evaluationQuestionId;
			}

			public void setEvaluationQuestionId(Integer evaluationQuestionId) {
			...
			public EvaAnswer getAnswerDetail() {
				return answerDetail;
			}

			public void setAnswerDetail(EvaAnswer answerDetail) {
		...
		public ArrayList<EvaQuestion> getEvaluationQuestions() {
			return evaluationQuestions;
		}

		public void setEvaluationQuestions(ArrayList<EvaQuestion> evaluationQuestions) {
		...
		public Integer getEvaluationSectionId() {
			return evaluationSectionId;
		}

		public void setEvaluationSectionId(Integer evaluationSectionId) {
	...
	public List<EvaSections> getEvaluationSections() {
		return evaluationSections;
	}

	public void setEvaluationSections(ArrayList<EvaSections> evaluationSections) {
